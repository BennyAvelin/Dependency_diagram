...
At the initial audit, eleven courses lacked a verified exact period pattern: `1MA038`, `1MA217`, `1MA336`, `1MA056`, `1MA081`, `1MA181`, `2NE814`, `2NE811`, `1MA344`, `1MA342`, `1MS051`. The follow-up below allows explicit term notes as semester reservations. Exact teaching periods remain unknown.
...
## Follow-up: semester selection

The degree project now defaults to semester 4. Mathematics in semester 3 requires an explicit exceptional choice. Per-course semester controls retain selections in browser storage and downloads, and report incompatible choices without silently moving courses. The saved five-target plan now places the project in spring 2028, leaving semester loads 20, 25, 0 and 30. The earlier browser observation above records the pre-follow-up behavior. The updated Node suite has 50 passing tests, including semester-choice persistence, changed prerequisite chains, conflicting pins, offering modes and project exceptions.
